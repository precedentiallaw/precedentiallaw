  ...
  const faqCategories = [
      ...
      faqs: [
        {
          ...
          question: "What are the key differences between fixed-term and flexible employment contracts under the new UAE Labour Law?",
          answer: "The UAE Labour Law (Federal Decree-Law No. 33 of 2021) introduced more flexibility in employment contracts. A Fixed-Term Contract has a specific end date (maximum 3 years, but renewable). A Flexible Work Contract allows work hours or days to change based on the employer's needs and volume of work. Other models like part-time or temporary work contracts also exist. Key differences lie in duration, renewal terms, notice periods for termination (which apply even in fixed-term contracts now), and potentially how end-of-service gratuity accrues.",
          additionalInfo: "Choosing the right contract type depends on the nature of the role and the business requirements. Understanding the implications of each model regarding job security, termination rights, and benefits calculation is crucial for both employers ensuring compliance and employees understanding their terms. The shift away from 'unlimited' contracts under the old law means all contracts now require careful attention to their specific terms and conditions.",
    ...
    },
    {
      ...
      faqs: [
        ...
        {
          category: "Family Law",
          question: "As an expat divorcing in the UAE, can I choose to apply my home country's law? How does that work?",
          answer: "Yes, the UAE's Civil Personal Status Law (Federal Decree-Law 41 of 2022) explicitly allows non-Muslim expatriates undergoing divorce in the UAE to request the application of their home country's law to substantive matters like the grounds for divorce, financial settlements (alimony), and child custody arrangements. This provides an alternative to the provisions outlined in the UAE civil law itself.",
          additionalInfo: "However, invoking this option involves complexities. You generally need to formally request the application of foreign law before the UAE court and may be required to provide certified and legally translated copies of the relevant laws from your home country. The court must then interpret and apply this foreign law, which can be challenging and may lead to debates if the laws are unclear or conflict with UAE public policy. Furthermore, deciding whether applying home country law is strategically advantageous requires a thorough analysis of how it compares to UAE law regarding your specific priorities (e.g., financial outcomes vs. custody arrangements).",
          disclaimer: "This information provides a general overview and does not constitute legal advice.",
          guidance: "Choosing the applicable law is a critical strategic decision in any expat divorce proceeding in the UAE, with significant implications for the outcome. Evaluating the potential benefits and drawbacks requires in-depth knowledge of both UAE law and the relevant foreign law. To make an informed choice and navigate this complex process effectively, seeking expert legal counsel from Precedential Law's family law team is essential."
        },
        {
          category: "Family Law",
          question: "How are financial settlements (like alimony/asset division) typically handled for expats divorcing under UAE's new Civil Personal Status Law?",
          answer: "The UAE's Civil Personal Status Law (Federal Decree-Law 41/2022) provides a framework for financial settlements for divorcing non-Muslim expats, moving away from traditional Sharia-based calculations. For post-divorce maintenance (similar to alimony), the law outlines several factors the judge considers when determining the amount and duration. These include the length of the marriage, the age of the wife, the financial situation of both spouses, the extent of the husband's fault contributing to the divorce, financial damages suffered by either party, and the level of care the wife provided to children.",
          additionalInfo: "Regarding asset division, the law doesn't mandate a specific split (like 50/50). Instead, it allows spouses to make claims during the divorce process regarding jointly owned assets or contributions made during the marriage. The judge has discretion in deciding how assets are divided, considering the specific circumstances and contributions of each party. This introduces flexibility but also requires careful presentation of evidence regarding financial contributions and assets acquired during the marriage. The process relies heavily on judicial assessment rather than fixed formulas.",
          disclaimer: "This information provides a general overview and does not constitute legal advice.",
          guidance: "Achieving a fair financial settlement under the new law requires understanding how judges evaluate the listed factors and effectively presenting your case regarding contributions and needs. The discretionary nature means outcomes can vary. To navigate financial claims effectively and protect your interests during divorce, securing strategic advice from Precedential Law's family law experts is crucial."
        }
      ]
    },
    {
      ...
      faqs: [
        ...
        {
          category: "Business & Commercial Law",
          question: "What is UBO registration and why is it mandatory for companies in the UAE?",
          answer: "UBO stands for Ultimate Beneficial Owner. UBO registration refers to the mandatory requirement for most companies operating in the UAE (both Mainland and many Free Zones) to identify, verify, and maintain an official register of the individuals who ultimately own or control the company, even if through a chain of corporate ownership. The purpose is to enhance corporate transparency, combat money laundering, terrorism financing, and other illicit financial activities, aligning the UAE with international standards.",
          additionalInfo: "Companies need to determine who qualifies as a UBO based on specific criteria (e.g., owning 25% or more of shares/voting rights, or exercising significant control through other means). This information must be recorded in a UBO Register kept at the company's premises and filed with the relevant licensing authority (e.g., DET for Mainland, specific Free Zone authorities). Failure to comply with UBO regulations, including maintaining accurate records and submitting declarations by deadlines, can result in significant financial penalties for the company.",
          disclaimer: "This information provides a general overview and does not constitute legal advice.",
          guidance: "Complying with UBO regulations is a crucial legal requirement for businesses in the UAE. Correctly identifying your UBOs and adhering to registration and reporting obligations can be complex, especially for intricate ownership structures. To ensure full compliance and avoid penalties, seeking guidance from Precedential Law's corporate team is essential."
        }
      ]
    },
    {
      ...
      faqs: [
        ...
        {
          category: "Real Estate Law",
          question: "What are my options if I need to terminate my Dubai rental contract early?",
          ...
          additionalInfo: "In the absence of a break clause, your primary option is to negotiate with your landlord. You can explain your situation and try to reach a mutual agreement, perhaps by offering to help find a replacement tenant or agreeing on a reasonable compensation amount. If the landlord refuses and you vacate, they may pursue a case at the Rental Dispute Centre (RDC) to claim compensation for the remaining rent period, although the RDC often seeks a fair resolution based on actual losses incurred. Proving 'force majeure' (unforeseeable circumstances making continuation impossible) is difficult.",
          disclaimer: "This information provides a general overview and does not constitute legal advice.",
        ...
        {
          category: "Real Estate Law",
          question: "What key legal checks should I perform before buying property in Dubai?",
          answer: "Buying property in Dubai, whether off-plan or ready, involves significant investment, making legal due diligence essential to protect yourself. Key checks include: verifying the seller's identity and ownership through the Title Deed; ensuring the developer has all necessary approvals from authorities like the Dubai Land Department (DLD) and RERA, especially for off-plan projects (check project registration and escrow account details); confirming the property matches the description in the Sale and Purchase Agreement (SPA); checking for any existing mortgages or charges registered against the property; understanding the applicable service charges and community rules; and ensuring the SPA terms are fair and clear regarding payment schedules, handover dates, specifications, and defect liability periods.",
          additionalInfo: "Skipping these checks can expose buyers to significant risks, such as title issues, non-compliant developments, unexpected costs, or contractual disputes with sellers or developers. The complexity increases with off-plan purchases where reliance on the developer's promises is higher. Engaging legal expertise early ensures all critical aspects are reviewed before committing.",
          disclaimer: "This information provides a general overview and does not constitute legal advice.",
          guidance: "Thorough legal due diligence is paramount when purchasing property in Dubai's dynamic market. Identifying potential issues before signing the SPA can save considerable time, money, and stress. To ensure your property investment is secure and legally sound, obtaining professional assistance from Precedential Law's real estate specialists for document review and due diligence is a prudent step."
        }
      ]
    },
    {
      title: "Wills & Estates (Expat Focus)",
      faqs: [
        {
    ...
    },
    {
      ...
      faqs: [
        {
          category: "Cheque Cases",
          question: "Is issuing a 'bounced cheque' (cheque with insufficient funds) still a crime in the UAE?",
          answer: "Significant changes to the UAE Commercial Transactions Law have largely decriminalized the act of issuing a cheque with insufficient funds for standard transactions (effective Jan 2022). The primary recourse for the beneficiary (recipient) is now through civil enforcement measures rather than an automatic criminal complaint leading to jail. The bounced cheque itself can act as an 'executive bond,' allowing faster debt recovery claims via the execution court.",
          additionalInfo: "However, criminal liability is NOT entirely eliminated. Certain actions associated with bounced cheques remain criminal offences, particularly those involving bad faith or fraud. Understanding precisely where the line falls between a civil issue and a criminal one under the current law is complex and depends heavily on the specific facts.",
          disclaimer: "This information provides a general overview and does not constitute legal advice.",
          guidance: "The legal landscape for bounced cheques has shifted significantly. Whether you received or issued a bounced cheque, understanding your rights, obligations, potential penalties (including administrative ones), and the correct legal pathway (civil vs. potential criminal exceptions) requires expert assessment. Consulting Precedential Law ensures you navigate this complex area correctly."
        },
        {
          category: "Cheque Cases",
          question: "What happens if I issue a cheque from an account I knew was closed? Is that still a crime?",
          answer: "Yes, issuing a cheque drawn on an account that the issuer knows is closed or non-existent at the time of issuance is generally considered an act of bad faith and typically remains a criminal offence under UAE law, even after the partial decriminalization of bouncing cheques due to insufficient funds. This falls under the category of cheque-related crimes that were not decriminalized, as it inherently involves deception.",
          additionalInfo: "Actions like ordering the bank to stop payment before the due date without a valid reason (maliciously), or deliberately signing/writing the cheque incorrectly to prevent it from being cashed, can also retain criminal implications. These acts demonstrate fraudulent intent, distinguishing them from simply having insufficient funds at the time of presentation.",
          disclaimer: "This information provides a general overview and does not constitute legal advice.",
          guidance: "Allegations involving cheques issued from closed accounts or with deliberate intent to defraud are treated seriously. Facing such accusations requires immediate and specialized legal defence. Contact Precedential Law urgently to understand the potential criminal implications and safeguard your rights."
        },
        {
          category: "Cheque Cases",
          question: "I received a bounced cheque. What is the process now to recover the money under the new law?",
          answer: "Under the amended law, a bounced cheque (due to insufficient funds) can be treated as an 'executive instrument' or 'executive bond'. This allows the beneficiary (holder of the cheque) to bypass a full civil lawsuit and directly approach the civil execution court to claim the amount. The process generally involves obtaining a certificate from the bank confirming the bounce, presenting this along with the original cheque to the execution court, and requesting enforcement action against the issuer's assets.",
          additionalInfo: "While streamlined, the process still involves specific legal procedures, filings, and potential court fees. The issuer may raise defences or objections during the execution proceedings. Furthermore, if the bounce falls under one of the criminal exceptions (e.g., bad faith, closed account), pursuing a criminal complaint alongside or instead of the civil execution might be possible or necessary.",
          disclaimer: "This information provides a general overview and does not constitute legal advice.",
          guidance: "Recovering funds from a bounced cheque, even with the faster 'executive bond' process, requires navigating specific court procedures correctly. Ensuring your claim is filed properly and understanding how to respond to potential defences is key. Precedential Law can assist you in efficiently pursuing recovery through the execution court."
        },
        {
          category: "Cheque Cases",
          question: "What are the potential administrative penalties if my cheque bounces (even if not criminal)?",
          answer: "Even where issuing a cheque with insufficient funds is not treated as a criminal offence, the law allows for several administrative penalties to be imposed on the issuer. These can include the withdrawal of existing chequebooks from the individual and banning them from receiving new ones for up to five years. Fines may also be levied. For businesses, penalties could extend to suspension of their commercial license for a period. Repeated offences can escalate the severity of these administrative measures.",
          additionalInfo: "These penalties are separate from the obligation to pay the cheque amount and aim to discourage the issuance of bad cheques. They can significantly impact an individual's or company's ability to conduct financial transactions.",
          disclaimer: "This information provides a general overview and does not constitute legal advice.",
          guidance: "The consequences of a bounced cheque extend beyond just the debt recovery process. Understanding the potential administrative penalties and how to mitigate them requires awareness of the current regulations. Precedential Law can advise on the full spectrum of potential consequences."
        }
      ]
    },
    {
      ...
      faqs: [
        {
          ...
          question: "My landlord isn't returning my security deposit after I moved out. What can I do?",
          answer: "Security deposits in Dubai are intended to cover potential damages to the property beyond normal wear and tear, or outstanding dues owed by the tenant upon vacating. Landlords are generally expected to return the deposit (or the remaining balance after justified deductions) within a reasonable period after the tenant moves out and hands back the property. If a landlord unfairly withholds the deposit, the primary recourse is to file a case with the Rental Dispute Centre (RDC).",
          additionalInfo: "To support your claim, it's crucial to have evidence: the tenancy contract (Ejari), proof of deposit payment, handover documents/photos showing the property's condition when you vacated, correspondence with the landlord regarding the deposit return, and evidence that you left the property in good condition (e.g., final utility bills paid, maintenance/cleaning receipts if applicable). The RDC will assess the evidence and the landlord's justification for deductions.",
          disclaimer: "This information provides a general overview and does not constitute legal advice.",
          guidance: "Disputes over security deposits are common. Effectively presenting your case to the RDC requires proper documentation and understanding of the process. Precedential Law can assist you in gathering evidence and filing a claim to recover your unfairly withheld deposit."
        },
        {
          category: "Rental Disputes",
          question: "Who is responsible for maintenance in a rented property in Dubai – the landlord or the tenant?",
          answer: "Responsibility for maintenance in Dubai rental properties is typically divided. Generally, the landlord is responsible for major maintenance and essential repairs necessary to keep the property habitable and functional (e.g., structural issues, major AC system failures, essential plumbing/electrical systems). The tenant is usually responsible for minor maintenance, routine upkeep, and repairs for damage caused by their own negligence or misuse.",
          additionalInfo: "However, the specific division of responsibilities should ideally be clearly outlined in the tenancy agreement (lease contract). Ambiguities in the contract often lead to disputes. Dubai Law No. 26 of 2007 (as amended) provides general principles, but the contract terms are key. If a landlord fails to perform necessary major maintenance, the tenant may have grounds to request repairs via the RDC or potentially seek termination of the lease in severe cases.",
          disclaimer: "This information provides a general overview and does not constitute legal advice.",
          guidance: "Clarifying maintenance responsibilities is crucial to avoid disputes. If you are unsure about your obligations or your landlord is neglecting essential repairs, reviewing your contract and seeking legal advice from Precedential Law can help clarify the position and determine the appropriate course of action."
        },
        {
          category: "Rental Disputes",
          question: "Can my landlord evict me immediately if I am late paying rent? What is the legal eviction process?",
          answer: "A landlord cannot evict a tenant immediately simply for being late with rent in Dubai. There is a formal legal process that must be followed. If a tenant fails to pay rent, the landlord must first serve the tenant with a formal written notice (typically via Notary Public or registered mail), demanding payment within 30 days.",
          additionalInfo: "Only if the tenant fails to pay within that 30-day notice period can the landlord then file an eviction case with the Rental Dispute Centre (RDC). The RDC will schedule a hearing, review the case, and issue a judgment. Even if the RDC orders eviction, there is still a process for enforcing that judgment. Attempting to evict a tenant without following these legal steps (e.g., changing locks, cutting utilities) is unlawful.",
          disclaimer: "This information provides a general overview and does not constitute legal advice.",
          guidance: "Facing eviction is a serious matter. Understanding the strict legal procedures landlords must follow and knowing your rights as a tenant is vital. If you have received a payment notice or face an eviction case, seeking immediate legal counsel from Precedential Law is essential to protect your tenancy."
        },
        {
          category: "Rental Disputes",
          question: "Does the Rental Dispute Centre (RDC) handle disputes for properties in Dubai Free Zones?",
          answer: "The jurisdiction of the Dubai Rental Dispute Centre (RDC) primarily covers rental disputes related to properties located within the Emirate of Dubai but outside of most major Free Zones that have their own specific regulations or dispute resolution mechanisms (like DIFC, which has its own laws and courts).",
          additionalInfo: "For properties within certain Free Zones, rental disputes might be handled by the Free Zone Authority itself or through other specified channels according to that Free Zone's rules. It is crucial to check the specific regulations governing the Free Zone where the property is located to determine the correct forum for resolving rental disputes. Assuming RDC jurisdiction for all Dubai properties can lead to filing in the wrong venue.",
          disclaimer: "This information provides a general overview and does not constitute legal advice.",
          guidance: "Determining the correct jurisdiction for your rental dispute is a critical first step. Filing in the wrong forum can cause delays and complications. Precedential Law can help verify the correct dispute resolution body based on your property's location (Mainland vs. specific Free Zone)."
        }
      ]
    },
    {
      title: "Fraud / Cheating Cases",
      faqs: [
        {
          category: "Fraud / Cheating Cases",
          question: "What legally constitutes 'fraud' or 'cheating' (Nasb) in the UAE?",
          answer: "Under the UAE Penal Code, fraud (often referred to colloquially as 'cheating' or Nasb in Arabic) generally involves intentionally deceiving someone through fraudulent means (like using a false name/capacity or misrepresentations) to induce them into giving up money, goods, or a legal right, thereby causing them unlawful loss for the perpetrator's gain or the gain of another. Key elements include intentional deception, reliance by the victim on that deception, and resulting financial loss or appropriation of property/rights.",
          additionalInfo: "The law covers various scenarios, from simple scams to complex financial frauds. Another related offence is 'Breach of Trust' (Khiyanat al-Amana), where someone lawfully entrusted with property misappropriates it for their own benefit. Proving fraud requires demonstrating the perpetrator's deceptive intent and actions meeting the legal definition.",
          disclaimer: "This information provides a general overview and does not constitute legal advice.",
          guidance: "Fraud allegations are serious criminal matters in the UAE with potentially severe penalties including imprisonment and fines. Whether you believe you are a victim of fraud or are facing accusations, understanding the specific legal elements and gathering strong evidence is critical. Immediate consultation with Precedential Law's criminal defence team is essential."
        },
        {
          category: "Fraud / Cheating Cases",
          question: "I think I've been scammed online / financially cheated. What should I do first?",
          answer: "If you suspect you have been a victim of an online scam, financial fraud, or 'cheating' in the UAE, the first crucial step is to gather all possible evidence related to the incident. This includes communication records (emails, messages), transaction details (bank transfers, receipts), relevant websites or profiles used by the perpetrator, and any documents involved. Secure this evidence immediately.",
          additionalInfo: "The next step is typically to report the matter to the relevant authorities. Depending on the nature of the fraud, this might involve filing a complaint with the Dubai Police (potentially via their e-crime platform for online scams) or directly with the Public Prosecution. Filing a formal complaint initiates an investigation. Given the complexities and potential cross-border nature of online fraud, acting quickly is important.",
          disclaimer: "This information provides a general overview and does not constitute legal advice.",
          guidance: "Falling victim to fraud can be distressing and financially damaging. Reporting the incident correctly and preserving evidence is vital for any chance of investigation or recovery. Precedential Law can guide you through the process of reporting fraud to the appropriate UAE authorities and advise on potential legal actions."
        },
        {
          category: "Fraud / Cheating Cases",
          question: "What is the difference between a civil fraud case and a criminal fraud case in the UAE?",
          answer: "The main difference lies in the objective and consequences. A criminal fraud case is initiated by the state (via Public Prosecution, often based on a police complaint) to punish the wrongdoer for violating the Penal Code. The focus is on proving criminal intent and actions beyond a reasonable doubt, with potential penalties including imprisonment, fines, and deportation for expats.",
          additionalInfo: "A civil fraud case is initiated by the victim (plaintiff) against the alleged perpetrator (defendant) in the civil courts. The objective is primarily to recover financial losses or damages suffered due to the fraudulent actions. The standard of proof is generally lower (balance of probabilities). While the same set of facts might give rise to both criminal and civil liability, they are separate legal processes pursued in different courts.",
          disclaimer: "This information provides a general overview and does not constitute legal advice.",
          guidance: "Understanding whether your situation warrants a criminal complaint, a civil lawsuit for damages, or potentially both, requires careful legal analysis. The strategic approach depends on your objectives and the available evidence. Precedential Law can advise on the appropriate legal avenues for addressing fraud based on your specific circumstances."
        }
      ]
    },
    {
      ...
      faqs: [
        {
          category: "Drug Cases",
          question: "What is the difference between drug possession for personal use and drug trafficking under UAE law?",
          answer: "UAE law makes a critical distinction between possessing illegal narcotic substances for personal use versus possessing them with the intent to distribute, promote, or sell (trafficking). Possession for personal use, while still a serious offence, may carry lesser penalties compared to trafficking, potentially including imprisonment and mandatory deportation for expatriates. Drug trafficking, however, is considered one of the most severe crimes and carries extremely harsh penalties, potentially including life imprisonment.",
          additionalInfo: "The determination between personal use and trafficking often depends on factors evaluated by law enforcement and the courts, such as the quantity of drugs found, the way they were packaged, the presence of scales or large amounts of cash, and other evidence suggesting intent to distribute rather than just consume. The legal distinction is crucial but relies heavily on case specifics.",
          disclaimer: "This information provides a general overview and DOES NOT constitute legal advice. Drug offences are extremely serious in the UAE.",
          guidance: "Being implicated in any drug-related activity in the UAE carries severe consequences. The distinction between use and trafficking dramatically impacts potential penalties. If you or someone you know is facing investigation or charges related to drugs, securing immediate, specialized criminal defence representation from Precedential Law is absolutely critical."
        },
        {
          category: "Drug Cases",
          question: "What are the potential penalties for drug-related offences (use or trafficking) in the UAE?",
          answer: "Penalties for drug offences under UAE Federal Law are severe and reflect a zero-tolerance policy. For drug trafficking, promoting, or manufacturing, penalties can include life imprisonment, and in some cases historically, the death penalty (though rarely implemented for drug offences recently). For possession for personal use, penalties typically involve imprisonment (duration varies based on drug type and circumstances) followed by mandatory deportation for expatriates upon completion of the sentence.",
          additionalInfo: "Recent legislative updates may introduce nuances regarding first-time offenders caught with drugs for personal use, potentially offering alternatives like rehabilitation centre placement instead of immediate imprisonment in some specific circumstances, but this is subject to strict conditions and judicial discretion. However, the baseline penalties remain extremely harsh. Bringing prescription medication containing controlled substances without proper documentation can also lead to serious charges.",
          disclaimer: "This information provides a general overview and DOES NOT constitute legal advice. Drug offences are extremely serious in the UAE.",
          guidance: "The potential penalties for drug offences in the UAE are among the most severe globally. Deportation is mandatory for expats convicted of possession or use. Facing any drug-related allegation requires urgent and expert legal defence. Contact Precedential Law immediately for specialized criminal law assistance."
        },
        {
          category: "Drug Cases",
          question: "What should I do immediately if I am arrested or investigated for a drug case in the UAE?",
          answer: "If you are arrested or placed under investigation for any drug-related offence in the UAE, the most critical first step is to exercise your right to remain silent and immediately request access to a lawyer. Do not make any statements, sign any documents (especially if not in a language you fully understand), or agree to anything without legal counsel present. Anything you say can be used against you.",
          additionalInfo: "Cooperate respectfully with law enforcement procedures (like identification) but firmly insist on your right to legal representation before any questioning or statement. Time is absolutely critical in drug cases. Contacting a specialized criminal defence lawyer, like those at Precedential Law, as soon as possible is paramount to protecting your rights throughout the investigation and potential prosecution process.",
          disclaimer: "This information provides a general overview and DOES NOT constitute legal advice. Drug offences are extremely serious in the UAE.",
          guidance: "Actions taken in the initial hours after an arrest can significantly impact the outcome of a drug case. Your immediate priority must be securing qualified legal representation. Contact Precedential Law without delay if you or someone you know requires defence against drug-related charges in the UAE."
        }
      ]
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-white/70 max-w-2xl mx-auto">
            Comprehensive answers to common legal questions in the UAE
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          {faqCategories.map((category, categoryIndex) => (
            <div key={categoryIndex} className="mb-8">
              <h3 className="text-precedential-gold mb-4 text-xl font-semibold">
                {category.title}
              </h3>
        ...
        __html: JSON.stringify({
          ...
          "mainEntity": faqCategories.flatMap(category => 
            category.faqs.map(faq => ({
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": `${faq.answer} ${faq.additionalInfo} ${faq.disclaimer} ${faq.guidance}`
              }
            }))
          )
        })
